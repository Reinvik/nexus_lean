                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        ...
                        <input
                            type="text"
                            required
                            className="w-full rounded-lg border-gray-300 border px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder:text-gray-600"
