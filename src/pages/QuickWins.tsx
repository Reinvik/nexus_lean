    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-slate-800 tracking-tight">Quick Wins</h1>
                    <p className="text-slate-600 font-medium mt-1">Registro y seguimiento de mejoras rápidas de alto impacto</p>
                </div>
                <button
