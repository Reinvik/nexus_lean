...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0B1F3F] flex items-center justify-center relative overflow-hidden font-sans selection:bg-brand-500/30">
            {/* Ambient Background Effects */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
                <div className="absolute top-[-10%] left-[-10%] w-96 h-96 bg-blue-600/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
                <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-brand-500/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
                <div className="absolute -bottom-32 left-20 w-96 h-96 bg-orange-600/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
            ...
            <div className="w-full max-w-md p-8 relative z-10 animate-fade-in-up">
                ...
                <div className="glass-panel p-8 sm:p-10 rounded-2xl border border-slate-700/50 shadow-2xl backdrop-blur-xl relative overflow-hidden group">
                    ...
                    {/* Top decoration line */}
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-900 via-brand-500 to-blue-900 opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>

                    <div className="text-center mb-10 relative">
                        <div className="inline-block relative">
                            <div className="absolute inset-0 bg-brand-500 blur-2xl opacity-20 rounded-full"></div>
                            <img src="/nexus-logo.svg" alt="Nexus Lean" className="h-32 w-auto relative mx-auto drop-shadow-lg" />
                        </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div className="space-y-1 group">
                            ...
                            <div className="relative transform transition-all duration-300 focus-within:scale-[1.02]">
                                ...
                                <input
                                    type="email"
                                    className="w-full bg-slate-900/50 border border-slate-700 text-slate-200 rounded-xl py-3 pl-10 pr-4 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500/50 transition-all duration-300 shadow-inner"
                        ...
                        <button
                            ...
                            className="w-full relative overflow-hidden group bg-gradient-to-r from-blue-900 to-brand-600 hover:from-blue-800 hover:to-brand-500 text-white font-semibold py-3.5 rounded-xl shadow-lg shadow-blue-900/20 transform transition-all duration-300 hover:shadow-brand-500/20 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
                        >
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-slate-500 text-sm">
                            ...
                            <Link to="/register" className="text-brand-400 hover:text-brand-300 font-medium transition-colors hover:underline decoration-brand-400/30 underline-offset-4">
                                Solicitar acceso
                            </Link>
                        </p>
