...
const VSMPage = () => {
    ...
    const visibleVsms = useMemo(() => {
        ...
        if (targetCompanyId === 'all') return vsms;

        return vsms.filter(v => v.companyId === targetCompanyId || v.responsible === user.name || !v.companyId);
    ...
    const handleSave = async () => {
        ...
        if (companyUsers && selectedVsm.responsible) {
